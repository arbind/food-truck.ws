...
describe 'TweetServices', ->
  ...
  describe 'find tweets: most recent tweets on top', =>
    ...
    it '(findUserTweets superman)', (done)=>
      TweetService.findUserTweets @superman0.screen_name(), (err, twtList)=>
        should.not.exist err, 'err'
    ...
    it '(findUserTweets limit2, superman)', (done)=>
      TweetService.findUserTweets @superman0.screen_name(), 2, (err, twtList)=>
        should.not.exist err, 'err'
        should.exist twtList, 'tweetList'
  ...
  describe 'delete tweets', =>
    ...
    it '(delete tweet)', (done)=>
      ...
      TweetService.tweetCount (err, numTweets)=>                                                    # number of total tweets
        TweetService.findUserTweets tweet.screen_name(), 0, (err, userTweets)=>                  # list of user tweets
          TweetService.findStreamerTweets tweet.streamer_screen_name(), 0, (err, streamerTweets)=>  # list of streamer tweets
            ...
            TweetService.tweetCount (err, tweetsLeft)=>                                             # number of total tweets left
              ...
              TweetService.findUserTweets tweet.screen_name(), 0, (err, userTweetsLeft)=>           # list of user tweets left
  ...
  describe 'auto prune tweet', =>
    it '(userTweetCount superman) = 3', (done)=>
      TweetService.findUserTweets superman0.screen_name(), 0, (err, userTweets)=>                  # list of user tweets
